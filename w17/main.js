...
FORM.addEventListener("submit", function (e) {
  ...
  if (FNAME.value !== "" && LNAME.value !== "") {
    ...
    const fpObj = new FP(
      FNAME.value,
      LNAME.value,
      parseInt(e.target.numhouse.value),
      e.target.housesize.value,
      e.target.foodCF.value,
      e.target.foodSource.value,
      parseInt(e.target.waterConsume.value),
      e.target.dish_washer.checked,
      parseInt(e.target.housePurchase.value),
      parseInt(e.target.wastePro.value),
      e.target.glassPts.checked,
      e.target.plaPts.checked,
      e.target.papPts.checked,
      e.target.aluPts.checked,
      e.target.stePts.checked,
      e.target.fooPts.checked,
      parseInt(e.target.perScore.value),
      parseInt(e.target.pubScore.value),
      parseInt(e.target.flightScore.value),
    );
    cfpData.push(fpObj);
    saveLS(cfpData);
    renderTbl(cfpData);
